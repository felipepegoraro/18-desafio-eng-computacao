import { addDoc, setDoc, updateDoc, collection, doc, deleteDoc } from 'firebase/firestore';
...
export const updatePet = async (petId: string, updatedPet: Partial<Pet>): Promise<void> => {
  try {
